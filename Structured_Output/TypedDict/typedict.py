...
class Review(TypedDict):
    ...
    key_themes: Annotated[str, "The key themes or aspects mentioned in the review, such as performance, battery life, camera quality, etc."]
    sentinment: Annotated[Literal['pos','neg'], "The overall sentiment of the review, either positive, negative, or neutral"]
    pros: Optional[Annotated[str, "The positive aspects of the product mentioned in the review"]]
    cons: Optional[Annotated[str, "The negative aspects of the product mentioned in the review"]]
